...
""",
'stift': """
<path d="M4 20.2h4.2L19.4 9a2.4 2.4 0 000-3.4l-1-1a2.4 2.4 0 00-3.4 0L4 15.8z"/>
<path d="M13.6 6.4 18 10.8"/>
<path d="M4 20.2 8.2 16"/>
""",
'palette': """
<path d="M12 2.8a9.2 9.2 0 000 18.4c1.5 0 2.4-.9 2.4-2.1 0-.6-.2-1-.6-1.4-.4-.4-.6-.8-.6-1.3 0-1.1.9-2 2-2h1.6a4.4 4.4 0 004.4-4.4c0-4-4.1-7.2-9.2-7.2z"/>
<circle cx="7.6" cy="11.4" r="1.2" fill="#000" stroke="none"/>
<circle cx="11" cy="7.4" r="1.2" fill="#000" stroke="none"/>
<circle cx="15.8" cy="8.6" r="1.2" fill="#000" stroke="none"/>
""",
'schrift': """
<path d="M4.4 7.2V4.8h15.2v2.4"/>
<path d="M12 4.8v14.4"/>
<path d="M8.6 19.2h6.8"/>
""",
'funke': """
<path d="M12 3.2 13.9 8.4 19.1 10.3 13.9 12.2 12 17.4 10.1 12.2 4.9 10.3 10.1 8.4z"/>
<path d="M18.4 15.6 19.2 17.8 21.4 18.6 19.2 19.4 18.4 21.6 17.6 19.4 15.4 18.6 17.6 17.8z"/>
""",
'handschlag': """
